...
use App\Model\rpclinica\Oft_biomicroscopia;
...
class Biomicroscopia extends Controller
{
    ...
    public function modal(Oft_biomicroscopia $formulario)
    {
        return  view('rpclinica.consulta_formularios.formularios.biomicroscopia.modal',['retorno'=>null]);
    }
 
 

    public function delete(Oft_biomicroscopia $formulario)
    {
        try {
            $formulario->delete();
        }
