...
use App\Model\rpclinica\Oft_acuidade;
...
class Acuidade extends Controller
{
    ...
    public function modal(Oft_acuidade $formulario)
    {
        return  view('rpclinica.consulta_formularios.formularios.acuidade_visual.modal',['retorno'=>null]);
    }
 
 

    public function delete(Oft_acuidade $formulario)
    {
        try {
            $formulario->delete();
        }
