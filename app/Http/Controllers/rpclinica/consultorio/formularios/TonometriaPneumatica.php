...
class TonometriaPneumatica extends Controller
{
    ...
    public function modal(Oft_tonometria_pneumatica $formulario)
    {
        return  view('rpclinica.consulta_formularios.formularios.tonometria_pneumatica.modal',['retorno'=>null]);
    }
 
 

    public function delete(Oft_tonometria_pneumatica $formulario)
    {
        try {
            $formulario->delete();
        }
