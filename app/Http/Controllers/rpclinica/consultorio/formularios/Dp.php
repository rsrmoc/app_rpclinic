...
use App\Model\rpclinica\Oft_dp;
...
class Dp extends Controller
{
    ...
    public function modal(Oft_dp $formulario)
    {
        return  view('rpclinica.consulta_formularios.formularios.dp.modal',['retorno'=>null]);
    }
  
    
    public function delete(Oft_dp $formulario)
    {
        try {
            $formulario->delete();
        }
