...
class Ectoscopia extends Controller
{
    ...
    public function modal(Oft_ectoscopia $formulario)
    {
        return  view('rpclinica.consulta_formularios.formularios.ectoscopia.modal',['retorno'=>null]);
    }
 
 

    public function delete(Oft_ectoscopia $formulario)
    {
        try {
            $formulario->delete();
        }
