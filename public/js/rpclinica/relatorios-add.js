...
"use strict";
/*!**************************************************!*\
  !*** ./resources/js/rpclinica/relatorios-add.js ***!
  \**************************************************/
...
Alpine.data('add_relatorios', function () {
  return {
      ...
      $('select[name="conteudo"]').on('select2:select', function (e) {
        ...
        if (conteudo != '') {
          axios__WEBPACK_IMPORTED_MODULE_0___default().get('/rpclinica/json/relatorios/conteudo-view', {
            ...
            _this.campos_tabela = response.data.colunas;

            _this.campos_tabela.forEach(function (campo) {
    ...
    createRelatorio: function createRelatorio() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/rpclinica/json/relatorios', {
        titulo: titulo,
        area: area,
        conteudo: conteudo,
