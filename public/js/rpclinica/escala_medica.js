...
"use strict";
/*!*************************************************!*\
  !*** ./resources/js/rpclinica/escala_medica.js ***!
  \*************************************************/
  ...
  return {
    ...
    init: function init() {
      ...
      */
      ...
      $('#form-Agenda #escala-profissional').on('select2:select', function (evt) {
        if (evt.params.data.id) {
          _this.modalEscala.prof = evt.params.data.id;

          _this.dadosProfissional(evt.params.data.id);
        } else {
          _this.dados_profissional.profissional = false;
          _this.dados_profissional.nome = null;
          _this.dados_profissional.whats = null;
          _this.dados_profissional.email = null;
          _this.dados_profissional.escala = '';
          _this.dados_profissional.disponibilidade = '';
        }
      });
    ...
    getAgendamentos: function getAgendamentos() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/rpclinica/json-escala-medica", form).then(function (res) {
        console.log(res.data);
        _this2.lista = res.data.request.query; //this.headerLivres = res.data.request.header.total;

        _this2.headerAgendados = res.data.request.header.agendado;
        _this2.headerConfirmados = res.data.request.header.confirmado;
        _this2.headerFinalizados = res.data.request.header.finalizado;
        _this2.headerPagos = res.data.request.header.pago;
        _this2.data_agenda = res.data.request.data;

        if (_this2.lista == '') {
          _this2.inicioIcone = true;
        }
      })["catch"](function (err) {
        _this2.messageDanger = err.response.data.message;
      })["finally"](function () {
        _this2.loading = false;
        console.log('this.inicioIcone ' + _this2.inicioIcone);
      });
    },
    ...
    dadosProfissional: function dadosProfissional() {
      var _this3 = this;
      ...
      if (!codigo) codigo = this.modalEscala.prof;

      if (!codigo) {
        return false;
      }

      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/rpclinica/json-escala-medica-prof/".concat(codigo, "?data=").concat(this.modalEscala.dt_agenda)).then(function (res) {
        console.log(res.data);

        if (res.data.profissional.cd_profissional) {
          _this3.dados_profissional.profissional = true;
          _this3.dados_profissional.nome = res.data.profissional.nm_profissional;
          _this3.dados_profissional.whats = res.data.profissional.whatsapp;
          _this3.dados_profissional.email = res.data.profissional.email;
          _this3.dados_profissional.escala = res.data.request.escalas;
          _this3.dados_profissional.disponibilidade = res.data.request.disponibilidade;
        } else {
          _this3.dados_profissional.profissional = false;
          _this3.dados_profissional.nome = null;
          _this3.dados_profissional.whats = null;
          _this3.dados_profissional.email = null;
          _this3.dados_profissional.escala = null;
          _this3.dados_profissional.disponibilidade = null;
        }
      })["catch"](function (err) {
        _this3.messageDanger = err.response.data.message;
      })["finally"](function () {
        _this3.loading = false;
      });
    },
    storeEscala: function storeEscala() {
      var _this4 = this;
      ...
      if (this.modalEscala.cd_escala) {
        var url = "/rpclinica/json-escala-medica-update/".concat(this.modalEscala.cd_escala);
      } else {
        var url = "/rpclinica/json-escala-medica-store";
      }

      axios__WEBPACK_IMPORTED_MODULE_0___default().post(url, form).then(function (res) {
        $('#cadastro-agendamento select#escala-profissional').val(null).trigger('change');
        $('#cadastro-agendamento select#escala-local').val(null).trigger('change');
        $('#cadastro-agendamento select#escala-tipo').val(null).trigger('change');
        $('#cadastro-agendamento select#escala-situacao').val(null).trigger('change');
        ...
        Object.values(err.response.data.errors).forEach(function (errors) {
          ...
          if (err.response.data.dados[0]) {
            _this4.checkEscala = err.response.data.dados[0];
            console.log(_this4.checkEscala);
            console.log(_this4.checkEscala.dados.length);
          }
        });
      })["finally"](function () {
  ...
  $('#calendar').datepicker({
    ...
    beforeShowDay: function beforeShowDay(e) {
      ...
      if (agendamentoDadosMes !== null && agendamentoDadosMes !== void 0 && agendamentoDadosMes[day]) {
        return {
          enabled: true,
          classes: agendamentoDadosMes === null || agendamentoDadosMes === void 0 ? void 0 : agendamentoDadosMes[day]
        };
      }
    }
  });
  ...
  $('#agendamento-paciente').on('select2:select', function (evt) {
    ...
    if (typeof cdPaciente == 'number') {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/rpclinica/json/paciente", {
        ...
        return _this5.loadingPaciente = false;
      });
    } else {
