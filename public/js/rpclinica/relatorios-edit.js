...
"use strict";
/*!***************************************************!*\
  !*** ./resources/js/rpclinica/relatorios-edit.js ***!
  \***************************************************/
  ...
  return {
    ...
    init: function init() {
      ...
      if (this.relatorio_campos.length > 0) {
        this.relatorio_campos.forEach(function (campo, index) {
          _this.tbody_campos.append("\n                            <tr>\n                                <td>".concat(campo.nome_coluna, "</td>\n                                <td>").concat(campo.alinhamento, "</td>\n                                <td>").concat(_this.findOptionLabelByValue('c_mascara', campo.mascara), "</td>\n                                <td>").concat(campo.limite ? campo.limite : '', "</td>\n                                <td>\n                                    <button @click=\"removeCampo(").concat(index, ")\" class=\"btn btn-danger btn-sm\">\n                                        <i class=\"fa fa-trash\"></i>\n                                    </button>\n                                </td>\n                            </tr>\n                        "));
        });
      }

      if (this.relatorio_parametros.length > 0) {
        this.relatorio_parametros.forEach(function (parametro, index) {
          $('#tbody-parametros').append("\n                            <tr>\n                                <td>".concat(parametro.nome_coluna, "</td>\n                                <td>").concat(_this.findOptionLabelByValue('p_operador', parametro.operador), "</td>\n                                <td>").concat(parametro.obrigatorio == 'S' ? 'Sim' : 'Não', "</td>\n                                <td>").concat(parametro.cd_param_padrao ? parametro.cd_param_padrao : '', "</td>\n                                <td class=\"text-center\">\n                                    <button @click=\"removeParametro(").concat(index, ")\" class=\"btn btn-danger btn-sm\">\n                                        <i class=\"fa fa-trash\"></i>\n                                    </button>\n                                </td>\n                            </tr>\n                        "));
        });
      }

      if (this.relatorio_calculos.length > 0) {
        this.relatorio_calculos.forEach(function (calculo, index) {
          $('#tbody-calculos').append("\n                            <tr>\n                                <td>".concat(calculo.nome_coluna, "</td>\n                                <td>").concat(_this.findOptionLabelByValue('ca_funcao', calculo.funcao), "</td>\n                                <td>\n                                    <button @click=\"removeCalculo(").concat(index, ")\" class=\"btn btn-danger btn-sm\">\n                                        <i class=\"fa fa-trash\"></i>\n                                    </button>\n                                </td>\n                            </tr>\n                        "));
        });
      }

      if (this.relatorio_ordem.length > 0) {
        this.relatorio_ordem.forEach(function (ordem, index) {
          $('#tbody-ordenar').append("\n                            <tr>\n                                <td>".concat(ordem.nome_coluna, "</td>\n                                <td>").concat(ordem.tipo == 'asc' ? 'Crescente' : 'Descendente', "</td>\n                                <td>\n                                    <button @click=\"removeOrdem(").concat(index, ")\" class=\"btn btn-danger btn-sm\">\n                                        <i class=\"fa fa-trash\"></i>\n                                    </button>\n                                </td>\n                            </tr>\n                        "));
        });
      }
    },
    insertCampos: function insertCampos() {
      var nome_coluna = $('select[name="c_campos"]').val();
      var alinhamento = $('select[name="c_alinhamento"]').val();
      var mascara = $('select[name="c_mascara"]').val();
      var limite = $('input[name="c_limite"]').val();
      var tipo_relatorio = $('select[name="tipo_relatorio"]').val();
      ...
      this.relatorio_campos.push({
        ...
        mascara: mascara,
        limite: limite !== null && limite !== void 0 ? limite : 0
      });
      var mask = '';
      ...
      this.tbody_campos.append("\n                    <tr>\n                        <td>".concat(nome_coluna == 'dt_inicial' ? 'Data Inicial' : nome_coluna == 'dt_final' ? 'Data Final' : nome_coluna, "</td>\n                        <td>").concat(alinhamento, "</td>\n                        <td>").concat(mask, "</td>\n                        <td>").concat(limite !== null && limite !== void 0 ? limite : 0, "</td>\n                        <td>\n                            <button @click=\"removeCampo(").concat(this.relatorio_campos.length - 1, ")\" class=\"btn btn-danger btn-sm\">\n                                <i class=\"fa fa-trash\"></i>\n                            </button>\n                        </td>\n                    </tr>\n                "));
    },
    ...
    insertParametros: function insertParametros() {
      var nome_coluna = $('select[name="p_campos"]').val();
      var operador = $('select[name="p_operador"]').val();
      var obrigatorio = $('select[name="p_obrigatorio"]').val();
      var p_padrao = $('select[name="p_padrao"]').val();
      ...
      $('#tbody-parametros').append("\n                    <tr>\n                        <td>".concat(nome_coluna == 'dt_inicial' ? 'Data Inicial' : nome_coluna == 'dt_final' ? 'Data Final' : nome_coluna, "</td>\n                        <td>").concat(this.findOptionLabelByValue('p_operador', operador), "</td>\n                        <td>").concat(obrigatorio == 'S' ? 'Sim' : 'Não', "</td>\n                        <td>").concat(p_padrao, "</td>\n                        <td class=\"text-center\">\n                            <button @click=\"removeParametro(").concat(this.relatorio_parametros.length - 1, ")\" class=\"btn btn-danger btn-sm\">\n                                <i class=\"fa fa-trash\"></i>\n                            </button>\n                        </td>\n                    </tr>\n                "));
    },
    ...
    insertCalculos: function insertCalculos() {
      var nome_coluna = $('select[name="ca_campos"]').val();
      var funcao = $('select[name="ca_funcao"]').val();
      ...
      $('#tbody-calculos').append("\n                    <tr>\n                        <td>".concat(nome_coluna, "</td>\n                        <td>").concat(this.findOptionLabelByValue('ca_funcao', funcao), "</td>\n                        <td>\n                            <button @click=\"removeParametro(").concat(this.relatorio_calculos.length - 1, ")\" class=\"btn btn-danger btn-sm\">\n                                <i class=\"fa fa-trash\"></i>\n                            </button>\n                        </td>\n                    </tr>\n                "));
    },
    ...
    insertOrdenar: function insertOrdenar() {
      var nome_coluna = $('select[name="o_campos"]').val();
      var tipo = $('select[name="o_tipo"]').val();
      ...
      $('#tbody-ordenar').append("\n                    <tr>\n                        <td>".concat(nome_coluna, "</td>\n                        <td>").concat(tipo == 'asc' ? 'Crescente' : 'Descendente', "</td>\n                        <td>\n                            <button @click=\"removeOrdem(").concat(this.relatorio_ordem.length - 1, ")\" class=\"btn btn-danger btn-sm\">\n                                <i class=\"fa fa-trash\"></i>\n                            </button>\n                        </td>\n                    </tr>\n                "));
    },
    ...
    editRelatorio: function editRelatorio() {
      ...
      var conteudo = $('select[name="conteudo"]').val();
      var tipo_relatorio = $('select[name="tipo_relatorio"]').val();
      var layout = $('select[name="layout"]').val();
      var restricao = $('select[name="restricao"]').val();
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().put('/rpclinica/json/relatorios', {
    ...
    deleteRelatorio: function deleteRelatorio() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"]('/rpclinica/json/relatorios', {
            data: {
              relatorio_id: _this2.relatorios['id']
            }
          }).then(function (response) {
            Swal.fire({
              icon: 'success',
    ...
    getCamposView: function getCamposView(registro) {
      ...
      var selectCampos = $('select[name="c_campos"]');
      var selectCalculos = $('select[name="ca_campos"]');
      var selectParametros = $('select[name="p_campos"]');
      var selectOrdenar = $('select[name="o_campos"]');
      axios__WEBPACK_IMPORTED_MODULE_0___default().get('/rpclinica/json/relatorios/conteudo-view', {
        params: {
          conteudo: registro
        }
      }).then(function (response) {
        _this3.campos_tabela = response.data.colunas;

        _this3.campos_tabela.forEach(function (campo) {
          var optionCampos = new Option(campo, campo, false, false);
          var optionCalculos = new Option(campo, campo, false, false);
          var optionParametros = new Option(campo, campo, false, false);
          var optionOrdenar = new Option(campo, campo, false, false);
    ...
    findOptionLabelByValue: function findOptionLabelByValue(selectName, value) {
      ...
      var options = document.querySelectorAll("select[name=\"".concat(selectName, "\"] option")); // Itera sobre os elementos option
