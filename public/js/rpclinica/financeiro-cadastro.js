...
"use strict";
/*!*******************************************************!*\
  !*** ./resources/js/rpclinica/financeiro-cadastro.js ***!
  \*******************************************************/
...
Alpine.data('appLancamentos', function () {
  return {
    ...
    init: function init() {
      ...
      $('#lancamentosCategorias').select2({
        data: [{
          ...
          return cat.cd_empresa == _this.empresaUsuario;
        }).map(function (cat) {
          return {
            id: cat.cd_categoria,
      ...
      $('#lancamentosSetores').select2({
        data: [{
          ...
          return set.cd_empresa == _this.inputsLancamento.cd_empresa;
        }).map(function (set) {
          return {
            id: set.cd_setor,
            text: set.nm_setor
      ...
      $('#lancamentosEmpresas').on('select2:select', function (evt) {
        var empresaId = evt.params.data.id;
        _this.inputsLancamento.cd_empresa = empresaId;
        $('#lancamentosCategorias').empty();
        $('#lancamentosCategorias').select2({
          data: [{
            id: '',
            text: 'Selecione'
          }].concat(_toConsumableArray(_this.categorias.filter(function (cat) {
      ...
      $('#lancamentosCategorias').on('select2:select', function (evt) {
        _this.inputsLancamento.cd_categoria = evt.params.data.id;

        var categoria = _this.categorias.find(function (cat) {
          return cat.cd_categoria == evt.params.data.id;
        });

        if (categoria !== null && categoria !== void 0 && categoria.descricao) _this.inputsLancamento.descricao = categoria.descricao;

        if (categoria !== null && categoria !== void 0 && categoria.cd_forma) {
          $('#lancamentosFormaPagamento').val(categoria.cd_forma).trigger('change');
          _this.inputsLancamento.cd_forma = categoria.cd_forma;
        }

        if (categoria !== null && categoria !== void 0 && categoria.cd_marca) {
          $('#lancamentosMarcas').val(categoria.cd_marca).trigger('change');
          _this.inputsLancamento.cd_marca = categoria.cd_marca;
        }

        if (categoria !== null && categoria !== void 0 && categoria.cd_setor) {
          $('#lancamentosSetores').val(categoria.cd_setor).trigger('change');
          _this.inputsLancamento.cd_setor = categoria.cd_setor;
        }

        if (categoria !== null && categoria !== void 0 && categoria.cd_conta) {
          $('#lancamentosConta').val(categoria.cd_conta).trigger('change');
          _this.inputsLancamento.cd_conta = categoria.cd_conta;

          var conta = _this.contas.find(function (con) {
            return con.cd_conta == categoria.cd_conta;
          });

          if (conta.tp_conta == 'CA') {
            _this.disabledInputsPagamento = true;
            _this.tp_conta = 'CA';
            ...
            $('#lancamentosFormaPagamento').select2({
              data: [{
                id: '',
                text: 'Selecione'
              }].concat(_toConsumableArray(_this.formas.filter(function (fo) {
                return fo.tipo == 'CA';
              }).map(function (arr) {
                return {
                  id: arr.cd_forma_pag,
            ...
            _this.tp_conta = 'CC';
            _this.disabledInputsPagamento = false;
            $('#lancamentosFormaPagamento').empty();
            $('#lancamentosFormaPagamento').select2({
              data: [{
                id: '',
        ...
        if (categoria !== null && categoria !== void 0 && categoria.cd_fornecedor) {
          ...
          _this.inputsLancamento.cd_fornecedor = categoria.cd_fornecedor;
        }
      ...
      $('#lancamentosTurmas').on('select2:select', function (evt) {
        _this.inputsLancamento.cd_turma = evt.params.data.id;
        ...
        $('#lancamentosEventos').select2({
          data: [{
            id: '',
            text: 'Selecione'
          }].concat(_toConsumableArray(_this.eventos.filter(function (cat) {
      ...
      $('#lancamentosEventos').on('select2:select', function (evt) {
        return _this.inputsLancamento.cd_evento = evt.params.data.id;
      });
      ...
      $('#lancamentosParcelas').on('select2:select', function (evt) {
        var _this$inputsLancament, _this$inputsLancament2, _this$inputsLancament3, _this$inputsLancament4, _this$inputsLancament5, _optionsDiasPeriodici;
        ...
        if (!((_this$inputsLancament2 = _this.inputsLancamento.data_vencimento) !== null && _this$inputsLancament2 !== void 0 && _this$inputsLancament2.trim())) {
          $('#lancamentosParcelas').val(null).trigger('change');
          toastr['error']('Preencha o campo de vencimento!');
          return;
        }

        if (!((_this$inputsLancament3 = _this.inputsLancamento.valor) !== null && _this$inputsLancament3 !== void 0 && _this$inputsLancament3.trim())) {
          $('#lancamentosParcelas').val(null).trigger('change');
          toastr['error']('Preencha o campo de valor!');
          return;
        }

        if (!((_this$inputsLancament4 = _this.inputsLancamento.periodicidade) !== null && _this$inputsLancament4 !== void 0 && _this$inputsLancament4.trim())) {
          $('#lancamentosParcelas').val(null).trigger('change');
        ...
        var valor = _this.inputsLancamento.dividir_parcelas ? parseFloat(_this.inputsLancamento.valor.replace('.', '').replace(',', '.')) / _this.inputsLancamento.qtde_parcelas : parseFloat(_this.inputsLancamento.valor.replace('.', '').replace(',', '.'));
        var dtVencimento = moment__WEBPACK_IMPORTED_MODULE_0___default()((_this$inputsLancament5 = _this.inputsLancamento.data_vencimento) !== null && _this$inputsLancament5 !== void 0 ? _this$inputsLancament5 : new Date().getTime());
        ...
        console.log(_this.inputsLancamento.parcelas);
      });
      $('#lancamentosPeriodicidade').on('select2:select', function (evt) {
        return _this.inputsLancamento.periodicidade = evt.params.data.id;
      });
    ...
    excluirParcela: function excluirParcela(index) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          _this2.inputsLancamento.parcelas.splice(index, 1);
        }
      });
    },
    ...
    clear: function clear() {
      ...
      this.opcaoValorRestante = 'confirmar', this.inputsLancamentoValorRestante = {
        data_vencimento: null,
        parcela_descricao: false,
        valor_restante: null
      };
    ...
    salvarLancamento: function salvarLancamento() {
      var _this$inputsLancament6,
          _this$inputsLancament7,
          _this3 = this;
      ...
      var valor = parseFloat(this.inputsLancamento.valor.replace('.', '').replace(',', '.'));
      var valor_pago = parseFloat((_this$inputsLancament6 = this.inputsLancamento.valor_pago) === null || _this$inputsLancament6 === void 0 ? void 0 : (_this$inputsLancament7 = _this$inputsLancament6.replace('.', '')) === null || _this$inputsLancament7 === void 0 ? void 0 : _this$inputsLancament7.replace(',', '.'));
      ...
      */
      ...
      axios.post('/rpclinica/json/financeiro-store-lancamento', data).then(function (res) {
        _this3.clear();
    ...
    submitModalValorRestante: function submitModalValorRestante() {
    ...
    salvarLancamentoGerarValorRestante: function salvarLancamentoGerarValorRestante() {
      var _this4 = this;

      var valor = parseFloat(this.inputsLancamento.valor.replace('.', '').replace(',', '.'));
      var valor_pago = parseFloat(this.inputsLancamento.valor_pago.replace('.', '').replace(',', '.'));
      this.loading = true;
      var data = Object.assign({}, this.inputsLancamento);
      data.valor = valor;
      ...
      data.parcelas.forEach(function (parcela) {
        ...
        parcela.valor = parcela.valor.replace('.', '').replace(',', '.');
        parcela.valor_pago = (_parcela$valor_pago = parcela.valor_pago) === null || _parcela$valor_pago === void 0 ? void 0 : (_parcela$valor_pago$r = _parcela$valor_pago.replace('.', '')) === null || _parcela$valor_pago$r === void 0 ? void 0 : _parcela$valor_pago$r.replace(',', '.');
      });
    ...
    salvarCadastro: function salvarCadastro() {
      var _this5 = this;

      axios.post('/rpclinica/json/financeiro-cadastro', this.campoCadastro).then(function (res) {
        toastr["success"](res.data.message);
        $("#" + res.data.id_campo).append('<option value="' + res.data.codigo + '">' + res.data.nome + '</option>'); //$("#"+res.data.id_campo).val(res.data.codigo);
...
Alpine.data('appTransferencias', function () {
  return {
    contasBancaria: contasBancariaTransf,
    contasBancariaTransf: contasBancariaTransf,
    empresaUsuario: empresaUsuario,
    ds_origem: '',
    ds_destino: '',
    inputsTransferencia: {
    ...
    init: function init() {
      ...
      $('#contasOrigemTransferencia').select2({
        data: [{
          id: '',
          text: 'Selecione'
        }].concat(_toConsumableArray(this.contasBancaria.map(function (cont) {
          return {
            id: cont.cd_conta,
            text: cont.nm_conta
          };
      ...
      $('#empresasOrigemTransferencia').on('select2:select', function (evt) {
        var empresaId = evt.params.data.id;
        _this6.inputsTransferencia.cd_empresa_origem = empresaId;
        $('#contasOrigemTransferencia').empty();
        $('#contasOrigemTransferencia').select2({
          // data: [
          //     { id: '', text: 'Selecione' },
          ...
          data: [{
            id: '',
            text: 'Selecione'
          }].concat(_toConsumableArray(_this6.contasBancaria.map(function (cont) {
            return {
              id: cont.cd_conta,
              text: cont.nm_conta
            };
      ...
      $('#contasOrigemTransferencia').on('select2:select', function (evt) {
        _this6.inputsTransferencia.cd_conta_origem = evt.params.data.id;
        _this6.ds_origem = evt.params.data.text;
        _this6.inputsTransferencia.descricao = 'Transf. da conta ' + _this6.ds_origem + ' para ' + _this6.ds_destino + '. ';
      });
      $('#empresasDestinoTransferencia').on('select2:select', function (evt) {
        var empresaId = evt.params.data.id;
        _this6.inputsTransferencia.cd_empresa_destino = empresaId;
        $('#contasDestinoTransferencia').empty();
        $('#contasDestinoTransferencia').select2({
          data: [{
            id: '',
      ...
      $('#contasDestinoTransferencia').on('select2:select', function (evt) {
        _this6.inputsTransferencia.cd_conta_destino = evt.params.data.id;
        _this6.ds_destino = evt.params.data.text;
        _this6.inputsTransferencia.descricao = 'Transf. da conta ' + _this6.ds_origem + ' para ' + _this6.ds_destino + '. ';
      });
    },
    clear: function clear() {
    ...
    submit: function submit() {
      ...
      this.loading = true;
      var data = Object.assign({}, this.inputsTransferencia);
      data.valor = data.valor.replace('.', '').replace(',', '.');
      axios.post('/rpclinica/json/financeiro-store-lancamento-transferencia', data).then(function (res) {
        toastr["success"](res.data.message);
