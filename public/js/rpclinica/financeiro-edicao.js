...
Alpine.data('appLancamentos', function () {
  return {
    ...
    selectedEmpresa: function selectedEmpresa(val) {
      ...
      $('#lancamentosEventos').select2({
        data: [{
          id: '',
          text: 'Selecione'
        }].concat(_toConsumableArray2(this.eventos.filter(function (cat) {
    ...
    submitUpdateParcela: function submitUpdateParcela() {
      var _this = this;

      this.loading = true;
      axios.put('/rpclinica/json/financeiro-update-lancamento-parcelas', this.inputsLancamento).then(function (res) {
