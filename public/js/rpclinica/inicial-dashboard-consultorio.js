...
/*!*****************************************************************!*\
  !*** ./resources/js/rpclinica/inicial-dashboard-consultorio.js ***!
  \*****************************************************************/
Alpine.data('app', function () {
  return {
    ...
    getCompromisso: function getCompromisso() {
      ...
      axios.get(routePanelCompromisso).then(function (res) {
    ...
    getDataPanel: function getDataPanel() {
      ...
      document.getElementById('flot1').innerHTML = this.graficoAtendimento; // document.getElementById('flot3').innerHTML =this.graficoAtendimento;
      ...
      axios.get("".concat(routePanelConsultorio, "/").concat(this.data)).then(function (res) {
        ...
        _this2.getChartAtendimentos(res.data.grafico); //this.getChartExames(res.data.header); 
