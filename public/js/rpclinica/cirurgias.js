...
"use strict";
/*!*********************************************!*\
  !*** ./resources/js/rpclinica/cirurgias.js ***!
  \*********************************************/
...
Alpine.data('app', function () {
  return {
    ...
    init: function init() {
      ...
      $('#texto_padrao').on('change', function (event) {
        ...
        _this.editor.setData(selectedValue);
    ...
    getPage: function getPage() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/rpclinica/json/cirurgias", form).then(function (res) {
        _this2.retornoLista = res.data.query;
        _this2.totalPages = Math.ceil(_this2.retornoLista.length / _this2.itemsPerPage);

        _this2.paginateData();
      })["catch"](function (err) {
        toastr['error'](err.response.data.message, 'Erro');
      })["finally"](function () {
        _this2.buttonPesquisar = "  <span class='glyphicon glyphicon-search' aria-hidden='true'></span> ";
    ...
    clickModal: function clickModal(dados, index) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/rpclinica/json/modal-central-laudos", dados).then(function (res) {
        _this3.textoPadrao = res.data.texto_padrao;
        _this3.infoModal.array_img = res.data.array_img;
        _this3.infoModal.notes = res.data.hist;
    ...
    addHistory: function addHistory() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/rpclinica/json/central-laudos/addHist", form).then(function (res) {
        axios__WEBPACK_IMPORTED_MODULE_0___default().get("/rpclinica/json/central-laudos/getHist/".concat(_this4.infoModal.cd_agendamento_item)).then(function (res) {
          _this4.infoModal.notes = res.data;
        ...
        _this4.buttonSalvarAnot = _this4.buttonSalvarTemp;
      });
    },
    submitLaudo: function submitLaudo() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/rpclinica/json/central-laudos/saveLaudo/".concat(this.infoModal.cd_agendamento_item), dados).then(function (res) {
        _this5.infoModal.conteudo_laudo = _this5.editor.getData();

        _this5.getPage();

        _this5.infoModal.situacao = 'E';
        toastr['success']('Laudo atualizado com sucesso!');
      })["catch"](function (err) {
        toastr['error'](err.response.data.message, 'Erro');
      })["finally"](function () {
        _this5.buttonSalvarLaudo = _this5.buttonSalvarTemp;
      });
    },
    liberarLaudo: function liberarLaudo() {
      var _this6 = this;
      ...
      this.swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
          if ($('#sn_laudo_checkbox').is(":checked")) {
            _this6.infoModal.sn_laudo = true;
          } else {
            _this6.infoModal.sn_laudo = false;
          }

          axios__WEBPACK_IMPORTED_MODULE_0___default().post("/rpclinica/json/central-laudos/liberarLaudo/".concat(_this6.infoModal.cd_agendamento_item), _this6.infoModal).then(function (res) {
            _this6.getPage();

            if (_this6.infoModal.sn_laudo == true) {
              toastr['success']('Laudo liberado com sucesso!');
              _this6.infoModal.situacao = 'R';
            } else {
