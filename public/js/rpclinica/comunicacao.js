...
"use strict";
/*!***********************************************!*\
  !*** ./resources/js/rpclinica/comunicacao.js ***!
  \***********************************************/
...
Alpine.data('app', function () {
  return {
    ...
    desconectar: function desconectar() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/rpclinica/comunicacao-desc').then(function (res) {
        console.log(res);
    ...
    getQrCode2: function getQrCode2() {
      ...
      this.div_info = false;
      this.loading_modal = true;
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/rpclinica/comunicacao-qr-code').then(function (res) {
        console.log(res);

        if (res.data.qrcode) {
          _this3.div_qr_code = true;
          _this3.qr_code = res.data.qrcode;
        } else {
          if (res.data.status == 200) {
            _this3.div_info = true;
          }
        }
      })["catch"](function (err) {
        return console.log(err);
      })["finally"](function () {
        return _this3.loading_modal = false;
      });
    },
    getGroup: function getGroup() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/rpclinica/comunicacao-group').then(function (res) {
        console.log(res.data.data);
        _this4.grupos = res.data.data;
      })["catch"](function (err) {
        return console.log(err);
      })["finally"](function () {
        return _this4.loading_group = false;
      });
    },
    getHorarios: function getHorarios() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/rpclinica/json/horarios', form).then(function (res) {
        _this5.horarios = res.data.dados;
      })["catch"](function (err) {
        return _this5.messageDanger = err.response.data.message;
      })["finally"](function () {
