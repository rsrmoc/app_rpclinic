    ...
    <style>
        * {
        ...
        .wrapper {
            ...
            /* Changed from #f8fafc to transparent to show body/watermark if needed, though watermark handles it */
            padding-bottom: 90px;
            /* Space for footer */
            overflow-x: hidden;
        ...
        .home-btn {
            ...
            /* Updated border to match light bg */
        ...
        .page-content {
            ...
            z-index: 1;
            padding-top: 80px;
            /* Adjusted for larger header - moved !important to allow overrides */
        }
        ...
        body {
            ...
            /* Better than hidden for vertical scroll containers */
...
<body class="min-h-screen bg-fixed">
    ...
    <div class="wrapper">
        ...
        <div class="page-content bg-transparent" style="padding-left: 4px !important; padding-right: 4px !important;">
            ...
            <!--start to header-->
            <!--start to header-->
            <header class="top-header fixed-top border-bottom d-flex align-items-center shadow-sm"
                style="background: #ffffff !important; height: 80px !important;">
                <nav class="navbar navbar-expand w-100 p-0 align-items-center px-3 position-relative">
                    ...
                    <!-- Center: Logo -->
                    <div class="position-absolute top-50 start-50 translate-middle d-flex flex-column justify-content-center align-items-center"
        ...
        <div class="bottom-nav-container no-print">
            <nav class="bottom-nav-card shadow-2xl">
                ...
                @if(auth()->guard('rpclinica')->user()->app_name == 'consultorio')
                    ...
                    <!-- Paciente -->
                    <a href="{{ route('app.paciente') }}"
                        class="nav-btn {{ request()->routeIs('app.paciente') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('app.agendamento') }}"
                        class="nav-btn {{ request()->routeIs('app.agendamento') ? 'active' : '' }}">
                    ...
                    <div class="home-btn-wrap">
                        ...
                        <span class="home-label {{ request()->routeIs('app.inicial') ? 'text-teal-400' : '' }}"></span>
                    </div>

                    <!-- Consulta -->
                    <a href="{{ route('app.consultorio') }}"
                        class="nav-btn {{ request()->routeIs('app.consultorio') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('app.perfil') }}"
                        class="nav-btn {{ request()->routeIs('app.perfil') ? 'active' : '' }}">
                ...
                @if(auth()->guard('rpclinica')->user()->app_name == 'adonhiran')
                    ...
                    <!-- Escala -->
                    <a href="{{ route('app.escala') }}"
                        class="nav-btn {{ request()->routeIs('app.escala') ? 'active' : '' }}">
                        <i class="bi bi-calendar3"></i>
                        <span>Escalas</span>
                    </a>
                    ...
                    <a href="{{ route('app.disponibilidade') }}"
                        class="nav-btn {{ request()->routeIs('app.disponibilidade') ? 'active' : '' }}">
                    ...
                    <!-- Produção -->
                    <a href="{{ route('app.producao') }}"
                        class="nav-btn {{ request()->routeIs('app.producao') ? 'active' : '' }}">
                        <i class="bi bi-coin"></i>
                        <span>Produção</span>
                    </a>

                    <!-- indicadores -->
                    <a href="{{ route('app.indicadores.escalas') }}"
                        class="nav-btn {{ request()->routeIs('app.indicadores') ? 'active' : '' }}">
        ...
        <!--start sidenav-->
        <div class="sidenav">
            <div class="offcanvas offcanvas-start bg-slate-900/95 backdrop-blur-xl border-r border-white/10"
                tabindex="-1" id="offcanvasSidenav">
                <div class="offcanvas-header bg-transparent border-b border-white/10">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="">
                            <h5 class="mb-0 text-white fw-bold truncate">
                                {{ auth()->guard('rpclinica')->user()->cd_usuario ?? 'Usuario' }}</h5>
                            <small class="text-slate-400">RPclinic</small>
                        </div>
                        <div class="ms-auto" >
                            <a href="javascript:;" class="text-slate-400 hover:text-white transition-colors"
                                data-bs-dismiss="offcanvas"><i class="bi bi-x-lg text-xl"></i></a>
                        </div>
                    </div>
                </div>
                <div class="offcanvas-body p-0">
                    <nav class="sidebar-nav">
                        <ul class="metismenu p-3 space-y-2" id="sidenav">
                            ...
                            <li>
                                <a href="{{ route('app.inicial') }}"
                                    class="group flex items-center px-4 py-3 text-slate-300 hover:text-white hover:bg-white/10 rounded-xl transition-all">
                            ...
                            @if(auth()->guard('rpclinica')->user()->app_name == 'consultorio')
                                ...
                                <li>
                                    <a href="{{ route('app.paciente') }}"
                                        class="group flex items-center px-4 py-3 text-slate-300 hover:text-white hover:bg-white/10 rounded-xl transition-all">
                                        <i
                                            class="bi bi-people text-lg me-3 group-hover:text-sky-400 transition-colors"></i>
                                ...
                                <li>
                                    <a href="{{ route('app.agendamento') }}"
                                        class="group flex items-center px-4 py-3 text-slate-300 hover:text-white hover:bg-white/10 rounded-xl transition-all">
                                        <i
                                            class="bi bi-calendar-check text-lg me-3 group-hover:text-teal-400 transition-colors"></i>
                                ...
                                <li>
                                    <a href="{{ route('app.consultorio') }}"
                                        class="group flex items-center px-4 py-3 text-slate-300 hover:text-white hover:bg-white/10 rounded-xl transition-all">
                                        <i
                                            class="bi bi-calendar2-heart text-lg me-3 group-hover:text-rose-400 transition-colors"></i>
                                        <span class="font-medium">Consultório</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('app.assinar') }}"
                                        class="group flex items-center px-4 py-3 text-slate-300 hover:text-white hover:bg-white/10 rounded-xl transition-all">
                                        <i
                                            class="bi bi-file-earmark-medical text-lg me-3 group-hover:text-indigo-400 transition-colors"></i>
                                ...
                                <li>
                                    <a href="{{ route('app.disponibilidade') }}"
                                        class="group flex items-center px-4 py-3 text-slate-300 hover:text-white hover:bg-white/10 rounded-xl transition-all">
                                        <i
                                            class="bi bi-clock-history text-lg me-3 group-hover:text-yellow-400 transition-colors"></i>
                                ...
                                <li>
                                    <a href="{{ route('app.producao') }}"
                                        class="group flex items-center px-4 py-3 text-slate-300 hover:text-white hover:bg-white/10 rounded-xl transition-all">
                                        <i
                                            class="bi bi-graph-up-arrow text-lg me-3 group-hover:text-green-400 transition-colors"></i>
                                        <span class="font-medium">Produção</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('app.indicadores') }}"
                                        class="group flex items-center px-4 py-3 text-slate-300 hover:text-white hover:bg-white/10 rounded-xl transition-all">
                                        <i
                                            class="bi bi-pie-chart text-lg me-3 group-hover:text-purple-400 transition-colors"></i>
                                ...
                                <li>
                                    <a href="{{ route('app.perfil') }}"
                                        class="group flex items-center px-4 py-3 text-slate-300 hover:text-white hover:bg-white/10 rounded-xl transition-all">
                                        <i
                                            class="bi bi-person-rolodex text-lg me-3 group-hover:text-orange-400 transition-colors"></i>
                            ...
                            @if(auth()->guard('rpclinica')->user()->app_name == 'adonhiran')
                                ...
                                <li>
                                    <a href="{{ route('app.escala') }}"
                                        class="group flex items-center px-4 py-3 text-slate-300 hover:text-white hover:bg-white/10 rounded-xl transition-all">
                                        <i
                                            class="bi bi bi-calendar3 text-lg me-3 group-hover:text-sky-400 transition-colors"></i>
                                ...
                                <li>
                                    <a href="{{ route('app.disponibilidade') }}"
                                        class="group flex items-center px-4 py-3 text-slate-300 hover:text-white hover:bg-white/10 rounded-xl transition-all">
                                        <i
                                            class="bi bi-calendar2-plus text-lg me-3 group-hover:text-teal-400 transition-colors"></i>
                                        <span class="font-medium">Disponibilidade</span>
                                    </a>
                                </li> 
                                <li>
                                    <a href="{{ route('app.producao') }}"
                                        class="group flex items-center px-4 py-3 text-slate-300 hover:text-white hover:bg-white/10 rounded-xl transition-all">
                                        <i
                                            class="bi bi-coin text-lg me-3 group-hover:text-indigo-400 transition-colors"></i>
                                        <span class="font-medium">Produção</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('app.indicadores.escalas') }}"
                                        class="group flex items-center px-4 py-3 text-slate-300 hover:text-white hover:bg-white/10 rounded-xl transition-all">
                                        <i
                                            class="bi bi-pie-chart-fill text-lg me-3 group-hover:text-rose-400 transition-colors"></i>
                                        <span class="font-medium">Indicadores</span>
                                    </a>
                                </li>
                                <li>
