                             ...
                             <div class="space-y-3">
                                 ...
                                 <div class="mt-3 grid grid-cols-2 gap-3 pt-3 border-t border-slate-50">
                                      ...
                                      <div class="px-2 py-2.5 rounded-xl flex items-center justify-center bg-indigo-50 border border-indigo-100 hover:bg-indigo-100 transition-colors">
                                          <span class="text-[10px] font-bold text-indigo-600 text-center uppercase tracking-wide whitespace-nowrap overflow-hidden text-ellipsis" x-text="capitalizeFirstLetter(agendamento.tipo_atend.nm_tipo_atendimento)"></span>
                                      </div>
                                      <!-- Situacao -->
                                      <div class="px-2 py-2.5 rounded-xl flex items-center justify-center bg-emerald-50 border border-emerald-100 hover:bg-emerald-100 transition-colors">
                                          <span class="text-[10px] font-bold text-emerald-600 text-center uppercase tracking-wide whitespace-nowrap overflow-hidden text-ellipsis" x-text="capitalizeFirstLetter(agendamento.situacao)"></span>
                                      </div>
                                 </div>
                             </div>
                         </div>
