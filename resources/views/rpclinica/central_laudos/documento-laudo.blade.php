  ...
  <style>
    * {
    ...
    footer {  
        ...
        font-weight: 600;
        font-style: italic; 
        color: {{ ($empresa->color_footer) ? $empresa->color_footer : '#070a09' }};
        text-align: center;
        line-height: 20px; 
    }
    .pagina { page-break-after: never; } 
    p {
        display: block;
    ...
    @if($Rascunho==true)
        <body style=" background-image: url(assets/images/rascunho.jpg);">
    @else 
        <body >
    @endif
    ...
    <header>
        ...
        <table   border="0" width="100%" style="border-bottom: {{ ($empresa->color_footer) ? $empresa->color_footer : '#070a09' }} 2px solid;"  >
            <tr>
                <td   style="text-align:center;">
                    <img src = "data:{{$empresa->type_logo}};base64,{{$empresa->logo}}" height="{{ $empresa->laudo_img_height }}" style="max-height: 80px;"  > 
                </td>  
                <td  style="text-align: center; font-style: italic; font-size: 30px; line-height: 25px; color: {{ ($empresa->color_footer) ? $empresa->color_footer : '#070a09' }}; font-weight: bold">
        ...
        <table width="200" border="0" cellpadding="3" cellspacing="3" width="100%" 
            ...
            <hr style="border-bottom: 1px solid #070a09; ">   <br>
        <table width="200" border="0" cellpadding="3" cellspacing="3" width="100%" 
        style="font-size: 14px; padding: 0px; padding-left: 4px; margin-top:  ">
        <tr>
    ...
    <footer>
        ...
        <br><br>
        <table width="100%" style="text-align: center; border-top: {{ ($empresa->color_footer) ? $empresa->color_footer : '#070a09' }} 2px solid; font-size: 15px;
            line-height: 13px; ">
            <tr>
    ...
    <main > 
        <p class="pagina"> {!! $item->conteudo_laudo !!}   </p>
