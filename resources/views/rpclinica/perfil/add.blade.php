        ...
        <div class="col-md-12 ">
            <div class="panel panel-white">
                <div class="panel-body">
                    ...
                    <form role="form" action="{{ route('perfil.store') }}" method="post" role="form">
                        @csrf
                            ...
                            <div class="col-md-2"> 
                                <div class="form-group">
                                    ...
                                    <select class="form-control" style="width: 100%" name="dashboard_inicial"> 
                                        ...
                                        <option value="exame" >Central de laudos</option> 
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3"> 
                                <div class="form-group">
                                    ...
                                    <select class="form-control"  style="width: 100%" name="ag_editar_horario"> 
                                        <option value="nao" >NÃO - Não Permite edição de Horário</option> 
                                        <option value="sim" >SIM - Permite edição de Horário</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            @foreach ($acessos as $indice => $rota)
                                ...
                                @endif
                                @php  $P_acesso=$rota->menu;  @endphp

                                <div class="col-md-3 col-sm-12 col-xs-12">
                                    <div class="form-group" style="margin-bottom: 3px;">
                                        <label>
                                            <input type="checkbox" name="paginas[]" value="{{ $rota->grupo }}" class="flat-red">
                            ...
                            @foreach ($relatorios as $indice => $rota)
                                ...
                                <div class="col-md-3 col-sm-12 col-xs-12">
                                    <div class="form-group" style="margin-bottom: 3px;">
                                        <label>
                                            <input type="checkbox" name="relatorios[]" value="{{ $rota->id }}" class="flat-red">
