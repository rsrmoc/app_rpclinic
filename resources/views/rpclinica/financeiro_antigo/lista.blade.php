            ...
            <div class="col-md-2" style="text-align: right; ">
                <div class="row">
                    <div class="col-md-6 col-md-offset-6" style="text-align: right;">
                        <a href="{{ route('financeiro.add') }}" style="text-align: center; font-weight: 900;">
                            <img src="{{ asset('assets\images\registroo.png') }}" height="50" style="padding-right: 20px;"> </a>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="row">
                                            <form x-on:submit.prevent="submitFilters" id="form-horario" class="col-md-3"
                                                ...
                                                <div class="form-data"  >
                                                    <div class="col-md-12" style="padding-right: 2px;  padding-left: 2px; margin-top: 5px;">
                                                        <label style="cursor: pointer"
                                                             @click="(inputsFilter.notCategoria==false) ? inputsFilter.notCategoria=true : inputsFilter.notCategoria=false ;" 
                                                             x-bind:class=" (inputsFilter.notCategoria==true) ? 'redNot' : ''"
                                                            x-html=" (inputsFilter.notCategoria==true) ? `<i class='fa fa-times'></i> Categoria` : 'Categoria'"    
                                                        >:</label>
                                                        <select class="form-control" name="profissional[]" data-placeholder="Todas Categorias"
                                                            style="width: 100%;" id="filterCategoria" multiple> 
                                                ...
                                                <div class="form-data" >
                                                    <div class="col-md-12" style="padding-right: 2px;  padding-left: 2px; margin-top: 5px;">
                                                        <label style="cursor: pointer"
                                                             @click="(inputsFilter.notSetor==false) ? inputsFilter.notSetor=true : inputsFilter.notSetor=false ;" 
                                                             x-bind:class=" (inputsFilter.notSetor==true) ? 'redNot' : ''"
                                                            x-html=" (inputsFilter.notSetor==true) ? `<i class='fa fa-times'></i> Setor` : 'Setor'"    
                                                        >:</label>
                                                        <select class="form-control" name="profissional[]" data-placeholder="Todos Setores"
                                                            style="width: 100%;" id="filterSetor" multiple> 
                                                ...
                                                <div class="form-data"  >
                                                    <div class="col-md-12" style="padding-right: 2px;  padding-left: 2px; margin-top: 5px;">
                                                        ...
                                                        <label style="cursor: pointer"
                                                             @click="(inputsFilter.notFornecedor==false) ? inputsFilter.notFornecedor=true : inputsFilter.notFornecedor=false" 
                                                             x-bind:class=" (inputsFilter.notFornecedor==true) ? 'redNot' : ''"
                                                            x-html=" (inputsFilter.notFornecedor==true) ? `<i class='fa fa-times'></i> Fornecedor ou Cliente` : 'Fornecedor ou Cliente'"    
                                                        >:</label>
                                                        <select class="form-control" name="profissional[]" data-placeholder="Todos Fornecedores"
                                                            style="width: 100%;" id="filterFornecedor" multiple> 
                                                ...
                                                <div class="form-data"  >
                                                    <div class="col-md-12" style="padding-right: 2px;  padding-left: 2px; margin-top: 5px;">
                                                        <label style="cursor: pointer"
                                                             @click="(inputsFilter.notConta==false) ? inputsFilter.notConta=true : inputsFilter.notConta=false ;" 
                                                             x-bind:class=" (inputsFilter.notConta==true) ? 'redNot' : ''"
                                                            x-html=" (inputsFilter.notConta==true) ? `<i class='fa fa-times'></i> Conta e Cartão` : 'Conta e Cartão'"    
                                                        >:</label>
                                                        <select class="form-control" name="profissional[]"  data-placeholder="Todas Contas"
                                                            style="width: 100%;" id="filterConta" multiple>
                                                ...
                                                <div class="form-data" >
                                                    <div class="col-md-12" style="padding-right: 2px;  padding-left: 2px; margin-top: 5px;">
                                                        <label style="cursor: pointer"
                                                             @click="(inputsFilter.notForma==false) ? inputsFilter.notForma=true : inputsFilter.notForma=false ;" 
                                                             x-bind:class=" (inputsFilter.notForma==true) ? 'redNot' : ''"
                                                            x-html=" (inputsFilter.notForma==true) ? `<i class='fa fa-times'></i> Forma de Pagamento` : 'Forma de Pagamento'"    
                                                        >:</label>
                                                        <select class="form-control" name="profissional[]" data-placeholder="Todas Formas de Pagamento"
                                                            style="width: 100%;" id="filterForma" multiple> 
                                                    ...
                                                    <div class="checkbox m-r-md" style="margin-top: 0; margin-bottom: 0; margin-top: 5px;">
                                                        <div class="col-md-6"
                                                            ...
                                                            <label style="padding: 0">
                                                                <div class="checker">
                                                                    <span>
                                                                        <input type="checkbox" id="inputsFilterCredito"
                                                        ...
                                                        <div class="col-md-6"
                                                            ...
                                                            <label style="padding: 0">
                                                                <div class="checker">
                                                                    <span>
                                                                        <input type="checkbox" id="inputsFilterDebito"
                                                    ...
                                                    <div class="checkbox m-r-md" style="margin-top: 0; margin-bottom: 0">
                                                        <div class="col-md-6"
                                                            ...
                                                            <label style="padding: 0">
                                                                <div class="checker">
                                                                    <span>
                                                                        <input type="checkbox" id="inputsFilterRealizado"
                                                        ...
                                                        <div class="col-md-6"
                                                            ...
                                                            <label style="padding: 0">
                                                                <div class="checker">
                                                                    <span>
                                                                        <input type="checkbox" id="inputsFilterNrealizado"
                                                    ...
                                                    <div class="checkbox m-r-md"
                                                        ...
                                                        <div class="col-md-6"
                                                            ...
                                                            <label style="padding: 0">
                                                                <div class="checker">
                                                                    <span>
                                                                        <input type="checkbox"  id="inputsFilterVencido"
                                                                            x-model="inputsFilter.vencido"  checked value="S" />
                                                                    </span>
                                                                </div> Vencido
                                                            </label>
                                                        </div>
                                                        <div class="col-md-6"
                                                            ...
                                                            <label style="padding: 0">
                                                                <div class="checker">
                                                                    <span>
                                                                        <input type="checkbox" id="inputsFilterAvencer"
                                                        ...
                                                        <div class="checkbox m-r-md"
                                                            ...
                                                            <div class="col-md-6"
                                                                ...
                                                                <label style="padding: 0;  ">
                                                                    <div class="checker">
                                                                        <span>
                                                                            <input type="checkbox" id="inputsFilterTransferencia"
                                                                                x-model="inputsFilter.transferencia"
                                                                                checked />
                                                                        </span>
                                                            ...
                                                            <div class="col-md-6"
                                                                ...
                                                                <label style="padding: 0;padding-bottom: 10px;">
                                                                    <div class="checker">
                                                                        <span>
                                                                            <input type="checkbox" id="inputsFilterLancamentos"
                                                                                x-model="inputsFilter.lancamentos"
                                                                                checked />
                                                                        </span>
                                                                    </div> Lançamentos
                                                                </label>
                                                        ...
                                                        <template x-if="paginatedData.length > 0">
                                                            ...
                                                            <tr x-show="!loadingPesq">
                                                                ...
                                                                <template x-if="labelSaldo.loadingSaldo">
                                                                    <td colspan="9" class="text-center"> <span class="glyphicon glyphicon-filter" aria-hidden="true"></span> </td>
                                                                </template>
                                                                <template x-if="!labelSaldo.loadingSaldo"> 
                                                        ...
                                                        <div class="right">
                                                            ...
                                                            <div  class="btn-group m-b-sm" style="    margin-bottom: 0px;">
                                                                ...
                                                                <button type="button" class="btn btn-default dropdown-toggle" id="situacaoButton" data-toggle="dropdown"   aria-expanded="false">
                                                                    <span class="btnConfirmado"><i class="fa fa-list" ></i>  &nbsp;&nbsp;   20 Registros&nbsp;&nbsp;&nbsp;<span class="caret"></span></span>
                                                                </button>

                                                                <ul class="dropdown-menu" role="menu">

                                                    
                                                                    <li x-on:click="registroPagina(50)">
                                                                        <a href="#" style="color:#333; font-weight: bold;padding: 4px 10px;">
                                                                            <i class="fa fa-list" style="padding-left:2px;  "></i>   50 Registros
                                                                        </a>
                                                                    </li>
