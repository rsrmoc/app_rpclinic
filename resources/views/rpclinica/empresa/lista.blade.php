                        ...
                        <table class="display table dataTable table-striped">
                            ...
                            <tbody>
                                @foreach ($empresas as $empresa)
                                    <tr id="empresa-{{ $empresa->cd_empresa }}">
                                        <th>{{ $empresa->cd_empresa }}</th>
                                        <td>{{ $empresa->nm_empresa }}</td>
                                        <td>{{ $empresa->razao_social }}</td>
                                        <td>{{ $empresa->cnpj }}</td>
                                        <td>
                                            <span class="{{ CSS_SN_ATIVO[$empresa->sn_ativo] }}">{{ SN_ATIVO[$empresa->sn_ativo] }}</span>
                                        </td>
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a href="{{ route('empresa.edit', ['empresa' => $empresa->cd_empresa]) }}" class="btn btn-success">
                                                    <i class="fa fa-edit"></i>
                                                </a>

                                                <button onclick="delete_cadastro('empresa-delete/{{ $empresa->cd_empresa }}', '#empresa-{{ $empresa->cd_empresa }}')"
