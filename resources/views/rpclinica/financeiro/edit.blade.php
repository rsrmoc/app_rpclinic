...
@section('content')
    <div class="page-title">
        ...
        <div class="page-breadcrumb">
            <ol class="breadcrumb">
                <li><a href="{{route('financeiro.listar')}}">Edição</a></li>
            </ol>
        </div>
    </div>
    <div id="main-wrapper">
                ...
                <ul class="nav nav-tabs nav-justified" role="tablist">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active fade in" id="TabLancamentos" x-data="appLancamentos">
                            <form x-on:submit.prevent="submitUpdateParcela" id="formUpdateParcela" class="panel glass-panel">
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                <label class="mat-label"  >Emissão <span
                                    ...
                                    <div class="row"
                                        style="background: rgba(255,255,255,0.05); padding: 7px;border: 1px solid rgba(255,255,255,0.1); ">
                                        ...
                                        <div class="row linaParcela" style="margin-top: 10px;" >
                                            ...
                                            <template x-if="parcela.cd_documento_boleto != inputsLancamento.cd_documento_boleto">
                                                <div class="col-md-3 col-sm-6 col-xs-12" style="padding-right:2px; padding-left: 2px;">
                                                    ...
                                                    <label class="bold" x-html="'Descrição <i>#'+parcela.cd_documento_boleto+'<i>   {{ ($documentoBoleto->tab_fatura?->situacao=='FECHADA') ? '<code> Fatura Fechada</code>' : ''}}'" > </label>    
                                                    <input type="text" class="form-control required" required=""
                                                        value=""  maxlength="100" 
                                    ...
                                    <div class="box-footer">
                                        @if(($documentoBoleto->tp_mov=='CA')||($documentoBoleto->tp_mov=='LC'))
