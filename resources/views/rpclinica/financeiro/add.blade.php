...
<div class="page-title">
    ...
    <div class="page-breadcrumb">
        <ol class="breadcrumb">
            <li><a href="{{route('financeiro.listar')}}">Cadastrar</a></li>
        </ol>
    </div>
</div>
<div id="main-wrapper">
            ...
            <ul class="nav nav-tabs nav-justified" role="tablist">
                ...
                <div class="tab-content">
                    <div x-data="appLancamentos" role="tabpanel" class="tab-pane active fade in" id="TabLancamentos">
                        ...
                        <form x-on:submit.prevent="salvarLancamento" class="panel glass-panel">
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12"  >
                                        <div class="col-md-12 col-sm-12 col-xs-12" style="background: rgba(255,255,255,0.05); padding: 7px;border: 1px solid rgba(255,255,255,0.1); "> 
                                ...
                                <div class="row m-b-md" style="margin-top: 10px;">
                                    ...
                                    <div class="col-md-2 col-sm-4 col-xs-12 ">
                                        ...
                                        <label
                                            x-text="disabledInputsPagamento==false ? 'Data do Vencimento' : disabledInputsPagamento==true ? 'Data da compra' : 'Data'">
                                    ...
                                    <div class="col-md-1 col-sm-2 col-xs-12" x-show="inputsLancamento.parcelar">
                        ...
                        <div class="modal fade" id="modalCadastro"  >
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form x-on:submit.prevent="salvarCadastro" class="panel glass-panel">
                                        <div class="modal-header">
