        ...
        <div class="col-md-12 ">
            <div class="panel panel-white">
                <div class="panel-body">
                    ...
                    <form role="form" action="{{ route('feriados.update', ['feriado' => $feriado->cd_feriado]) }}" method="post" role="form">
                        @csrf
                            ...
                            <div class="col-md-4">
                                <div class="form-group @if($errors->has('nm_feriado')) has-error @endif">  
                                    ...
                                    <input type="text"
                                        ...
                                        maxlength="100"
                                        aria-required="true"
                                        value="{{ old('nm_feriado',$feriado->nm_feriado) }}">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group @if($errors->has('dt_feriado')) has-error @endif">  
                                    ...
                                    <input type="date"
                                        class="form-control required"
                                        required
                                        value="{{ old('dt_feriado',$feriado->dt_feriado) }}"
                                        name="dt_feriado"
                                        maxlength="10"
                                        aria-required="true">
                            ...
                            <div class="col-md-2">
                                <div class="form-group @if($errors->has('tp_feriado')) has-error @endif">  
                                        ...
                                        <select class="form-control" required="" name="tp_feriado">
                                            ...
                                            <option value="FE" @if(old('tp_feriado',$feriado->tp_feriado)  == 'FE') selected @endif>Feriado</option>
                                            <option value="FA" @if(old('tp_feriado',$feriado->tp_feriado)  == 'FA') selected @endif>Facultativo</option> 
                                        </select>
                                ...
                                <div class="form-group @if($errors->has('nivel')) has-error @endif">  
                                    <label>Nivel do Feriado: <span class="red normal"></span></label>
                                        <select class="form-control" required="" name="nivel">
                                            <option value="">Selecione</option>
                                            <option value="NACIONAL" @if(old('nivel',$feriado->nivel)  == 'NACIONAL') selected @endif>Nacional</option>
                                            <option value="ESTADUAL" @if(old('nivel',$feriado->nivel)  == 'ESTADUAL') selected @endif>Estadual</option> 
                                        </select>
                                        @if($errors->has('nivel'))
                            ...
                            <div class="col-md-2">
                                <div class="form-group @if($errors->has('sn_bloqueado')) has-error @endif">  
                                    ...
                                    <select class="form-control" required="" name="sn_bloqueado">
                                        <option value="">Selecione</option>
                                        <option value="S" @if(old('sn_bloqueado',$feriado->sn_bloqueado)  == 'S') selected @endif>Sim</option>
                                        <option value="N" @if(old('sn_bloqueado',$feriado->sn_bloqueado)  == 'N') selected @endif>Não</option> 
                                    </select>
