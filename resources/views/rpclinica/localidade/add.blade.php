                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="fname">Cep: <span
                                            class="red normal">*</span></label> 
                                    <input type="text" class="form-control required" value="{{ old('cep') }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="fname">Cidade: <span
                                            class="red normal">*</span></label> 
                                    <input type="text" class="form-control required" value="{{ old('ds_cidade') }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-control" name="uf" required>
                                    ...
                                    @foreach ($ufs as $uf)
                                        <option value="{{ $uf->cd_uf }}">{{ $uf->nm_uf . ' ( '.$uf->cd_uf.' )' }}</option>
                                    @endforeach
                                </select>
                            </div>
