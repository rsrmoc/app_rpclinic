        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel-control">
                    ...
                    <a href="javascript:void(0);" x-on:click="deleteEctoscopia(1)" data-toggle="tooltip" data-placement="top" title=""
        ...
        <div role="tabpanel">
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane fade  active in" id="tabCadExa">
                    ...
                    <form class="form-horizontal" x-on:submit.prevent="storeEctoscopia" id="form_ECTOSCOPIA"  method="post" >
                        @csrf
                        ...
                        <div class="form-group" style="margin-bottom: 5px;">
                            <div class="col-md-12">
                                <label for="input-placeholder" class=" control-label"
                                    style="  padding-top: 0px;">Exame externo OD:</label>
                                <textarea rows="4" class="form-control" name="comentario">{{ old('comentario') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group" style="margin-bottom: 5px;">
                            <div class="col-md-12">
                                <label for="input-placeholder" class=" control-label"
                                    style="  padding-top: 0px;">Exame externo face:</label>
                                <textarea rows="4" class="form-control" name="comentario">{{ old('comentario') }}</textarea>
                            </div>
                        </div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="tabFotoExa">
                    <form class="form-horizontal" x-on:submit.prevent="storeEctoscopiaImg" id="form_ECTOSCOPIA_IMG" method="post" >
                        @csrf 
                        <div class="form-group " style="margin-bottom: 5px;">
    ...
    <div class="panel-group"   role="tablist" aria-multiselectable="true">
        ...
        <div class="panel panel-default" style="    border-radius: 0px;"> 
            ...
            <div class="panel-heading" role="tab" id="headHist" style="margin: 1px; padding: 10px; " >
                <h4 class="panel-title" x-on:click="modalEctoscopia(1)" style=" font-size: 12px; cursor: pointer; padding-top:1px; padding-bottom:1px;   "> 
