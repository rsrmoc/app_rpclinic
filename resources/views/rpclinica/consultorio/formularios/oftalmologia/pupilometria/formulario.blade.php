...
<div class="col-md-7">
    ...
    <div class="panel panel-white ui-sortable-handle">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel-control">
                        ...
                        <a href="javascript:void(0);" x-on:click="deletePupilometria(1)" data-toggle="tooltip" data-placement="top" title=""
        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal" x-on:submit.prevent="storePupilometria" id="form_PUPILOMETRIA" method="post" >
                @csrf
                ...
                <div class="form-group  " style="margin-bottom: 5px;">
                    ...
                    <div class="col-sm-4" style=" ">
                        ...
                        <select class="form-control " name="cd_profissional" style="width: 100%">
                            <option value="">SELECIONE</option>
                            <option value="BI">Bilateral (ambos)</option>
    ...
    <div class="panel-group"   role="tablist" aria-multiselectable="true">
        ...
        <div class="panel panel-default" style="    border-radius: 0px;"> 
            ...
            <div class="panel-heading" role="tab" id="headHist" style="margin: 1px; padding: 10px; " >
                <h4 class="panel-title" x-on:click="modalPupilometria(1)" style=" font-size: 12px; cursor: pointer; padding-top:1px; padding-bottom:1px;   "> 
