    ...
    <div class="panel-body">
        ...
        action="{{ route('auto.refracao.salve',$agendamento->cd_agendamento) }}">
            ...
            <div class="form-group " style="margin-bottom: 5px;">
                ...
                <div class="col-sm-6" style=" ">
                    <label for="input-help-block" class="control-label">Tio de Lazer:</label>
                    <select class="form-control " name="cd_profissional" style="width: 100%">
                        <option value="">SELECIONE</option>
                    </select>
                    @if($errors->has('cd_profissional'))
            ...
            <div class="form-group">
                <label for="input-Default" class="col-sm-3 control-label">Polo Posterior:</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control input-sm" id="input-Default">
                </div>

                <label for="input-Default" class="col-sm-3 control-label">Potência (mW):</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control input-sm" id="input-Default">
                </div>
            </div>
            <div class="form-group">
                <label for="input-Default" class="col-sm-3 control-label">Superior:</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control input-sm" id="input-Default">
                </div>
            ...
            <div class="form-group">
                <label for="input-Default" class="col-sm-3 control-label">Inferior:</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control input-sm" id="input-Default">
                </div>
            ...
            <div class="form-group">
                <label for="input-Default" class="col-sm-3 control-label">Nasal:</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control input-sm" id="input-Default">
                </div>
            ...
            <div class="form-group">
                <label for="input-Default" class="col-sm-3 control-label">Temporal:</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control input-sm" id="input-Default">
                </div>
            ...
            <div class="form-group">
                <label for="input-Default" class="col-sm-3 control-label">Inferior Nasal:</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control input-sm" id="input-Default">
                </div>
            ...
            <div class="form-group">
                <label for="input-Default" class="col-sm-3 control-label">Inferior Temporal:</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control input-sm" id="input-Default">
                </div>
            ...
            <div class="form-group">
                <label for="input-Default" class="col-sm-3 control-label">Superior Nasal:</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control input-sm" id="input-Default">
                </div>
            ...
            <div class="form-group">
                <label for="input-Default" class="col-sm-3 control-label">Superior Temporal:</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control input-sm" id="input-Default">
                </div>
            ...
            <div class="form-group">
                <label for="input-Default" class="col-sm-3 control-label">Mácula:</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control input-sm" id="input-Default">
                </div>
            ...
            <div class="form-group">
                <label for="input-Default" class="col-sm-3 control-label">Mira (um):</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control input-sm" id="input-Default">
                </div>
            ...
            <div class="form-group">
                <label for="input-Default" class="col-sm-3 control-label">Intervalo (ms):</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control input-sm" id="input-Default">
                </div>
