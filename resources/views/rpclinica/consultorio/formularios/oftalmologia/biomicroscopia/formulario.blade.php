        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel-control">
                    ...
                    <a href="javascript:void(0);" x-on:click="deleteomicroscopia(1)" data-toggle="tooltip" data-placement="top" title=""
        ...
        <div role="tabpanel">
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane fade  active in" id="tabCadExa">
                    ...
                    <form class="form-horizontal" x-on:submit.prevent="storeBiomicroscopia" id="form_BIOMICROSCOPIA"  method="post" >
                        @csrf
                ...
                <div role="tabpanel" class="tab-pane fade" id="tabFotoExa">
                    <form class="form-horizontal" x-on:submit.prevent="storeBiomicroscopia" id="form_BIOMICROSCOPIA_IMG"  method="post" >
                        @csrf
                        <div class="form-group " style="margin-bottom: 5px;">
    ...
    <div class="panel-group"   role="tablist" aria-multiselectable="true">
        ...
        <div class="panel panel-default" style="    border-radius: 0px;"> 
            ...
            <div class="panel-heading" role="tab" id="headHist" style="margin: 1px; padding: 10px; " >
                <h4 class="panel-title" x-on:click="modalBiomicroscopia(1)" style=" font-size: 12px; cursor: pointer; padding-top:1px; padding-bottom:1px;   "> 
