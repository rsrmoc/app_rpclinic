<div class="col-md-7 col-sm-7 col-lg-6 col-xs-12  ">
    ...
    <div class="panel panel-white ui-sortable-handle">
        <div class="panel-heading">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="panel-title"><span class="glyphicon glyphicon-file" aria-hidden="true"></span> Atestados
                    </h3>
                    <div class="panel-control">
                        <a href="javascript:void(0);" data-toggle="tooltip"
                            x-on:click="deleteAtestado(ATESTADO.formData.cd_documento)" data-placement="top"
        ...
        <div class="panel-body" x-data="{ index: 0, showHistory: false }">
            <form class="form-horizontal" x-on:submit.prevent="storeAtestado" id="form_ATESTADO" method="post"
                x-show="!showHistory">
                @csrf
                ...
                <div class="form-group" style="margin-bottom: 5px;">
                    <div class="col-md-12">
                        ...
                        <textarea rows="4" class="form-control" name="descricao" x-model="ATESTADO.formData.descricao"></textarea>
                    </div>
                </div>
                ...
                <fieldset disabled>
                    ...
                    <div class="form-group" style="margin-bottom: 5px;">
                        <div class="col-md-12">
                            <label for="input-placeholder" class=" control-label"
                                style="  padding-top: 0px;">Comentário:</label>
                            <textarea rows="4" class="form-control" name="descricao" x-model="ATESTADO.history[index].descricao"></textarea>
                        </div>
                    </div>
                </fieldset>
                        ...
                        <div class="col-md-6" style="text-align: left">
                            <div class="btn-group" role="group" aria-label="First group">
                                ...
                                <button type="button" class="btn btn-default"
                                    @click="index = Math.min(ATESTADO.history.length - 1, index + 1)"
                                    :disabled="index === ATESTADO.history.length - 1">
                                    <i class="fa fa-forward"></i>
                                </button>
                                <button type="button" class="btn btn-default"
                                    @click="index = ATESTADO.history.length - 1"
                                    :disabled="index === ATESTADO.history.length - 1">
...
<div class="col-md-2 col-sm-2 col-xs-12 col-lg-3">
                    ...
                    <div class="panel-control">
                        ...
                        <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title=""
                            data-original-title="Histórico Completo"><i class="icon-docs"
                                x-on:click="modalAtestado({{ $agendamento->cd_paciente }},null)"></i></a>
    ...
    <div class="panel-group" role="tablist" aria-multiselectable="true">
        ...
        <template x-if="ATESTADO.history.length > 0">
            <div class="panel panel-default" style="border-radius: 0px;">
                <template x-for="item in ATESTADO.history">
                    ...
                    <div class="panel-heading" role="tab" id="headHist" style="margin: 1px; padding: 10px; ">
                        <h4 class="panel-title"
                            ...
                            x-on:click="modalAtestado({{ $agendamento->cd_paciente }},item.cd_documento)">
                        </h4>
                    </div>
