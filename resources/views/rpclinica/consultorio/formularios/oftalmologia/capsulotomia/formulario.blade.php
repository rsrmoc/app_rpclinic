        ...
        action="{{ route('auto.refracao.salve',$agendamento->cd_agendamento) }}">
            ...
            <div class="form-group " style=" ">
                <div class="col-sm-3" style="   ;">
                    <label for="input-Default" class="  control-label ">Tamanho (Um):</label>
                ...
                <div class="col-sm-3" style="  padding-left: 5px;">
                    <label for="input-Default" class="  control-label ">N° Disparos:</label>
                    <input type="text" class="form-control input-sm text-center" name="dt_liberacao"
                        value="{{ old('dt_liberacao') }}">
                    @if($errors->has('dt_liberacao'))
                    <div class="error">{{ $errors->first('dt_liberacao') }}</div>
                ...
                <div class="col-sm-3" style="  padding-left: 5px;">
                    <label for="input-Default" class="  control-label ">Potência (mW):</label>
                    <input type="text" class="form-control input-sm text-center" name="dt_liberacao"
                        value="{{ old('dt_liberacao') }}">
                    @if($errors->has('dt_liberacao'))
                    <div class="error">{{ $errors->first('dt_liberacao') }}</div>
                ...
                <div class="col-sm-3" style="  padding-left: 5px;">
                    <label for="input-Default" class="  control-label ">Energia Utilizada (J):</label>
                    <input type="text" class="form-control input-sm text-center" name="dt_liberacao"
                        value="{{ old('dt_liberacao') }}">
                    @if($errors->has('dt_liberacao'))
                    <div class="error">{{ $errors->first('dt_liberacao') }}</div>
