...
<div class="panel panel-white ui-sortable-handle">
    ...
    <div class="panel-body">
        ...
        action="{{ route('auto.refracao.salve',$agendamento->cd_agendamento) }}">
                ...
                <div class="form-content">
                    <div class="col-sm-6">
                        <label for="input-Default"
                            ...
                            direito:</label>
                        <div class="bg-block-plus" style="transform: translateY(0); background-image: url('{{ asset('assets/images/02.png') }}');">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="bg-block-plus"
                            style="transform: translateY(0); background-image: url({{ asset('assets/images/02.png') }});">
                            <div class="row" style="padding: 7px;">
                                <div class="col-sm-12">
                                    <div class="form-control-double">
                                        <input type="text"
            ...
            <div class="row" style="transform: translateX(-22px);">
                <div class="form-content"
                    style="width: 92%; margin-left: 18px; transform: translateY(21px);">
                    <div class="textarea-box" style="float: left">
                        <label for="textarea-box"
                            class="label-textarea">OD (cél/mm2):
                        </label>
                        <div class="form-control-double">
                            <input type="text" class="form-control"
                                name="cd_profissional"
                                style="width: 49px;height: 28px;"
                                value="">
                            <input type="text" class="form-control"
                                name="cd_profissional"
                                style="width: 49px;height: 28px;"
                    ...
                    <div class="textarea-box" style="float: right">
                        <label for="textarea-box"
                            class="label-textarea">OE (cél/mm2):
                        </label>
                        <div class="form-control-double">
                            <input type="text" class="form-control"
                                name="cd_profissional"
