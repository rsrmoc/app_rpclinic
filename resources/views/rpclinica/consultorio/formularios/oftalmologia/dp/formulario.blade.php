...
<div class="col-md-7">
    ...
    <div class="panel panel-white ui-sortable-handle">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel-control">
                        <a href="javascript:void(0);" x-on:click="deleteDp(1)" data-toggle="tooltip" data-placement="top" title=""
        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal" x-on:submit.prevent="storeDp" id="form_DP" method="post" >
                @csrf
                ...
                <div class="form-group " style=" ">
                    ...
                    <div class="col-sm-4" style=" padding-right: 5px;">
                        <label for="input-Default" class="  control-label ">OD Longe (mm):</label>
                    ...
                    <div class="col-sm-4" style="  padding-left: 5px; ">
                        <label for="input-Default" class="  control-label ">OE Longe (mm):</label>
                        <input type="text" class="form-control input-sm text-center" name="dt_liberacao"
                            value="{{ old('dt_liberacao') }}">
                        @if($errors->has('dt_liberacao'))
                        <div class="error">{{ $errors->first('dt_liberacao') }}</div>
                    ...
                    <div class="col-sm-4" style="  padding-left: 5px; ">
                        <label for="input-Default" class="  control-label ">DP (mm):</label>
                        <input type="text" class="form-control input-sm text-center" name="dt_liberacao"
                            value="{{ old('dt_liberacao') }}">
                        @if($errors->has('dt_liberacao'))
                        <div class="error">{{ $errors->first('dt_liberacao') }}</div>
                ...
                <div class="form-group " style=" ">
                    ...
                    <div class="col-sm-4" style=" padding-right: 5px;">
                        <label for="input-Default" class="  control-label ">OD Perto (mm):</label>
                        <input type="text" class="form-control input-sm text-center" name="dt_liberacao"
                            value="{{ old('dt_liberacao') }}">
                        @if($errors->has('dt_liberacao'))
                        <div class="error">{{ $errors->first('dt_liberacao') }}</div>
                    ...
                    <div class="col-sm-4" style="  padding-left: 5px; ">
                        <label for="input-Default" class="  control-label ">OE Perto (mm):</label>
                        <input type="text" class="form-control input-sm text-center" name="dt_liberacao"
                            value="{{ old('dt_liberacao') }}">
                        @if($errors->has('dt_liberacao'))
                        <div class="error">{{ $errors->first('dt_liberacao') }}</div>
    ...
    <div class="panel-group"   role="tablist" aria-multiselectable="true">
        ...
        <div class="panel panel-default" style="    border-radius: 0px;"> 
            ...
            <div class="panel-heading" role="tab" id="headHist" style="margin: 1px; padding: 10px; " >
                <h4 class="panel-title" x-on:click="modalDp(1)" style=" font-size: 12px; cursor: pointer; padding-top:1px; padding-bottom:1px;   "> 
