<div class="modal fade" id="cadastro-confirmacao" style="z-index: 10050; overflow-x: hidden; overflow-y: auto;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control"  tabindex="-1" style="width: 100%"  name="agenda"  >
                                                ...
                                                @foreach ($parametros['agenda'] as $linha)
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control"  tabindex="-1" style="width: 100%"  name="profissional"  >
                                                <option value="">Selecione</option>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control"  tabindex="-1" style="width: 100%"  name="situacao"  >
                                                <option value="">Selecione</option>
                                                @foreach ($parametros['situacao'] as $linha)
                                                        ...
                                                        <div class="btn-group ">
                                                            ...
                                                            <template x-if="( ( (item.sn_finalizado) ? item.sn_finalizado : 'N' ) =='N' )"> 
                                                                <ul class="dropdown-menu" role="menu">
                                                                    @foreach ($parametros['situacao-agend'] as $linha)
