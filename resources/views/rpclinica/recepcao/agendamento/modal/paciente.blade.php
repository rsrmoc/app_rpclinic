<form role="form" x-on:submit.prevent="atualizarPaciente" method="post" id="form-pac" enctype="multipart/form-data">
    ...
    <div class="row">
                ...
                <label><strong>Nome: </strong><span class="red normal">*</span>
                    <template x-if="modalPaciente.cd_paciente">
                        <span class="label label-success"
                            x-html="'&nbsp;&nbsp;Prontuário : &nbsp;'+modalPaciente.cd_paciente+'&nbsp;&nbsp;'"
                            style="background: #30daca; border: #009688 1px solid;"> </span>
                    </template>
                </label>
                <input type="text" class="form-control required" required value="{{ old('nome') }}" name="nome"
                    maxlength="100" x-model="modalPaciente.nm_paciente" aria-required="true">
            </div>
        </div>
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="date" class="form-control" value="{{ old('data_de_nascimento') }}"
                    name="data_de_nascimento" x-model="modalPaciente.dt_nasc" required maxlength="100"
                    aria-required="true">
            </div>
        </div>
        <div class="col-md-2">
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="text" class="form-control" x-model="modalPaciente.rg" value="{{ old('rg') }}"
                    name="rg" maxlength="100" aria-required="true">
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="form-group">
                <label><strong>CPF: </strong> @if ($request['obriga_cpf'] == 'sim')  <span class="red normal">*</span>  @endif
                </label>
                <input x-mask="999.999.999-99" class="form-control" x-model="modalPaciente.cpf"
                    value="{{ old('cpf') }}" @if ($request['obriga_cpf'] == 'sim') required @endif name="cpf"
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="text" x-model="modalPaciente.cartao_sus" class="form-control"
                    value="{{ old('cartao_sus') }}" name="cartao_sus" maxlength="100" aria-required="true">
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control  " x-model="modalPaciente.nome_social"
                    value="{{ old('nome_social') }}" name="nome_social" maxlength="100" aria-required="true">
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control  " x-model="modalPaciente.nm_responsavel" value=""
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="text" class="form-control  " x-model="modalPaciente.cpf_responsavel" value=""
    ...
    <div class="row">
        ...
        <div class="col-md-7">
            <div class="form-group">
                ...
                <input type="text" x-model="modalPaciente.nm_mae" class="form-control"
                    value="{{ old('nome_da_mae') }}" name="nome_da_mae" maxlength="100" aria-required="true">
            </div>
        </div>
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="date" class="form-control" value="{{ old('dt_nasc_mae') }}" name="dt_nasc_mae"
                    x-model="modalPaciente.dt_nasc_mae" maxlength="100" aria-required="true">
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{ old('celular_mae') }}" name="celular_mae"
                    x-model="modalPaciente.celular_mae" maxlength="100" aria-required="true">
            </div>
        </div>
        ...
        <div class="col-md-5">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{ old('nome_do_pai') }}" name="nome_do_pai"
                    maxlength="100" x-model="modalPaciente.nm_pai" aria-required="true">
            </div>
        </div>
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="date" class="form-control" value="{{ old('dt_nasc_pai') }}" name="dt_nasc_pai"
                    x-model="modalPaciente.dt_nasc_pai" maxlength="100" aria-required="true">
            </div>
        </div>
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{ old('celular_pai') }}" name="celular_pai"
                    x-model="modalPaciente.celular_pai" maxlength="100" aria-required="true">
            </div>
        </div>

        <div class="col-md-3">
            <div class="form-group">
                <label><strong>Profissão do Paciente: </strong></label>
                <input type="text" class="form-control" value="{{ old('profissao') }}" name="profissao"
                    maxlength="100" x-model="modalPaciente.profissao" aria-required="true">
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                <label class="mat-label"><strong>Convênio</strong> <span class="red normal">*</span></label>
                <select class="form-control" name="convenio" id="pac-convenio" style="width: 100%;">
                    <option value="">SELECIONE</option>
                    @foreach ($convenios as $convenio)
                        <option value="{{ $convenio->cd_convenio }}"
                            @if (old('convenio') == $convenio->cd_convenio) selected @endif>{{ $convenio->nm_convenio }}</option>
                    @endforeach
                </select>
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{ old('cartao') }}" name="cartao"
                    maxlength="100" x-model="modalPaciente.cartao" aria-required="true">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label><strong>Data de Validade: </strong><span class="red normal"></span></label>
                <input type="date" class="form-control" value="{{ old('validade') }}" name="validade"
                    maxlength="100" x-model="modalPaciente.dt_validade" aria-required="true">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{ old('telefone') }}" name="telefone"
                    maxlength="100" x-model="modalPaciente.fone" aria-required="true">
            </div>
        </div>
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{ old('celular') }}" name="celular"
                    maxlength="100" x-model="modalPaciente.celular" aria-required="true">
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="email" class="form-control" value="{{ old('logradouro') }}" name="logradouro"
                    x-model="modalPaciente.email" maxlength="100" aria-required="true">
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{ old('logradouro') }}" name="logradouro"
                    maxlength="100" x-model="modalPaciente.logradouro" aria-required="true">
            </div>
        </div>
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{ old('numero') }}" name="numero"
                    maxlength="100" x-model="modalPaciente.numero" aria-required="true">
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{ old('complemento') }}" name="complemento"
                    maxlength="100" x-model="modalPaciente.complemento" aria-required="true">
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{ old('bairro') }}" name="bairro"
                    maxlength="100" x-model="modalPaciente.nm_bairro" aria-required="true">
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{ old('cidade') }}" name="cidade"
                    maxlength="100" x-model="modalPaciente.cidade" aria-required="true">
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <select name="uf" class="form-control" id="pac-uf" style="width: 100%;">
                    ...
                    @foreach (ESTADOS as $estado)
                        <option value="{{ $estado['sigla'] }}" @if (old('uf') == $estado['sigla']) selected @endif>
                            {{ $estado['nome'] }}</option>
                    @endforeach
                </select>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group" style="text-align: right; margin-top: 10px;">
                    <button type="submit" class="btn btn-success"><i class="fa fa-check"></i> Salvar
                        Paciente</button>
                </div>
            </div>
        </div>
