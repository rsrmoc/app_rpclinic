        ...
        <div class="col-md-12 ">
            <div class="panel panel-white">
                <div class="panel-body">
                    ...
                    <form x-on:submit.prevent="submit" action="{{ route('estoque.saida.store') }}" method="post" role="form" x-ref="formSaida">
                            ...
                            <div class="col-md-2 ">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="exampleInputEmail1"
                                        placeholder="Documento" name="numero_documento" value="{{ old('numero_documento') }}" required>
                                </div>
                            </div>
                        </div>
                    ...
                    <button x-on:click="$refs.formSaida.querySelector('input[type=submit]').click()" class="btn btn-success">Cadastrar</button>
                </div>
            </div>
        </div>
