...
@section('content')
    <div class="page-title">
        ...
        <div class="page-breadcrumb">
            <ol class="breadcrumb">
                <li><a href="{{ route('estoque.saida.listar') }}">Saida de Produtos</a></li>
            </ol>
        </div>
    </div>
            ...
            <div class="panel panel-white">
                <div class="panel-body">
                    ...
                    <form x-on:submit.prevent="submit"
                        action="{{ route('estoque.saida.update', ['saida' => $saida->cd_solicitacao]) }}" method="post"
                        role="form" x-ref="formSaida">
                            ...
                            <div class="col-md-2 ">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="exampleInputEmail1"
                                        placeholder="Queixa Principal" name="data" value="{{ $saida->dt_saida }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class=" form-control" tabindex="-1" style=" width: 100%"
                                        ...
                                        @foreach ($estoques as $estoque)
                                            <option value="{{ $estoque->cd_estoque }}"
                                                @if ($saida->cd_estoque == $estoque->cd_estoque) selected @endif>
                                                {{ $estoque->nm_estoque }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select class=" form-control" tabindex="-1" style=" width: 100%"
                                        ...
                                        @foreach ($setores as $setor)
                                            <option value="{{ $setor->cd_setor }}"
                                                @if ($saida->cd_setor == $setor->cd_setor) selected @endif>
                                                {{ $setor->nm_setor }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-2 ">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="exampleInputEmail1"
                                        ...
                                        value="{{ $saida->nr_doc }}" required>
                                </div>
                            </div>
                        </div>

                        <template x-for="produto, indice in produtosEntrada">
                            <template x-if="!produto.cd_solic_saida">
                                <div>
                    ...
                    <button x-on:click="$refs.formSaida.querySelector('input[type=submit]').click()"
...
@section('scripts')
    ...
    <script>
        ...
        const saidaProdutos = @js($saida->saidaProdutos);
    </script>
    <script src="{{ asset('js/rpclinica/estoque-saida.js') }}"></script>
@endsection
