            ...
            <div class="panel panel-white">
                <div class="panel-body">
                    ...
                    <form role="form"
                        ...
                        method="post"
                        role="form"
                        action="{{ route('escala-tipo.update', ['tipo' => $tipo->cd_escala_tipo]) }}" >
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control required" value="{{ old('nome', $tipo->nm_tipo_escala ) }}"
