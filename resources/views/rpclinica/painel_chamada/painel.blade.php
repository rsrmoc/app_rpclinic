        ...
        <div id="callarea" class="row" style="line-height:1.23">
            <div class="col m4">
                <div class="card-panel center-align" style="margin-bottom:0">
                    ...
                    <!-- adicionado -->
                    <audio id="campainha" src="{{asset('painel_chamada/sound/sound.mp3')}}"></audio>
            ...
            <div class="col m8">
                <div class="card-panel center-align" style="margin-bottom:0">
                    ...
                    <!-- alterado -->
                    <span id="senhaAtual"  style="font-size:185px;color:red;font-weight:bold;line-height:1.5">UNI-23</span><br>
