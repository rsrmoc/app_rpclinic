        ...
        <div class="col-md-12 ">
            <div class="panel panel-white">
                <div class="panel-body">
                    ...
                    <form x-on:submit.prevent="submit" x-ref="formEntrada" action="{{ route('estoque.entrada.store') }}" method="POST">
                            ...
                            <div class="col-md-2 ">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="exampleInputEmail1"
                                        placeholder="Queixa Principal" name="data" value="{{ old('data') }}" required>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <select class=" form-control" tabindex="-1" style=" width: 100%"
                                        ...
                                        @foreach ($motivos as $motivo)
                                            <option value="{{ $motivo->cd_motivo }}"
                                                @if (old('motivo') == $motivo->cd_motivo) selected @endif>
                                                {{ $motivo->motivo }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-2 ">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="exampleInputEmail1"
                                        placeholder="Ordem de Compras" name="ordem_compras" value="{{ old('ordem_compras') }}" required />
                                </div>
                            </div>
                            <div class="col-md-2 ">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="exampleInputEmail1"
                                        placeholder="Nr.Documento" name="numero_documento" value="{{ old('numero_documento') }}" required />
                                </div>
                            </div>
                                    ...
                                    <select class=" form-control" tabindex="-1" style=" width: 100%"
                                        ...
                                        @foreach ($fornecedores as $fornecedor)
                                            <option value="{{ $fornecedor->cd_fornecedor }}"
                                                @if (old('fornecedor') == $fornecedor->cd_fornecedor) selected @endif>
                    ...
                    <button x-on:click="$refs.formEntrada.querySelector('input[type=submit]').click()" class="btn btn-success">Cadastrar</button>
                </div>
            </div>
        </div>
