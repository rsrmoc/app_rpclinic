...
<body class="page-login">
    ...
    <style>
        ...
        body {
            ...
            background-image: url({{ asset("assets/images/laudos-medicos.jpg") }});
    ...
    <div class="login-page">
        <div class="form">
            ...
            <form class="m-t-md" action="{{ route('laudos.valida') }}" style="margin: 0px;"  enctype="multipart/form-data" method="post">
                @csrf
         
                    <img   style="margin-left: 5%; margin-right: 5%;" src="{{ asset('assets/images/laudos/empresa/logo_portal_laudos.png') }}" style="margin-bottom:20px;">
                    ...
                    <div class="form-group"> 
                        <input type="text" class="form-control" name="cd_usuario"  placeholder='Usuario' required >
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control" name="password" placeholder="Senha" required>
                    </div>
                    <button type="submit" class="btn btn-success btn-block btn-lg" style="font-size: 15px; "> 
                        <span class="glyphicon glyphicon-log-out" style="margin-right: 5px" aria-hidden="true"></span> Acessar Portal  </button>
                    <!--
